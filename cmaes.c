...
void readpara_init (readpara_t *, int dim, int seed,  const double * xstart, 
		    ...
		    int  maxevals_b,  double stopfitness_b);
void readpara_exit(readpara_t *);
void readpara_ReadFromFile(readpara_t *, const char *szFileName);
void readpara_SupplementDefaults(readpara_t *,int  maxevals_b);
	  ...
	  int  maxevals_b,  double stopfitness_b)
{
  ...
  t->stStopFitness.val = stopfitness_b;
  t->stopTolFun = 1e-12;; 
  ...
  readpara_SupplementDefaults(t, maxevals_b);
...
/* --------------------------------------------------------- */
void 
readpara_SupplementDefaults(readpara_t *t,  int  maxevals_b)
{
  double t1, t2;
  int N = t->N; 
  clock_t cloc = clock();
