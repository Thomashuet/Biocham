...
public class IntermediateVertexAssocNode  extends VertexView{

	
	public IntermediateVertexAssocRenderer renderer=new IntermediateVertexAssocRenderer();
	//private static DefaultGraphCell cell;
	private DefaultGraphCell parentCell;
	BiochamEdgeData userObject;
	Rectangle2D bounds;
	
	public IntermediateVertexAssocNode(Object cell) {
		super(cell);
		if(cell instanceof IntermediateVertexAssoc){
			parentCell=(IntermediateVertexAssoc)cell;
			...
			if(parentCell!=null){
				...
				if(((IntermediateVertexAssoc)parentCell).getUserObject() instanceof BiochamEdgeData){
					userObject=(BiochamEdgeData)((IntermediateVertexAssoc)parentCell).getUserObject();
					if(userObject!=null){
	...
	public class IntermediateVertexAssocRenderer extends VertexRenderer { 
			...
			if(userObject!=null){
				...
				if(pos!=null){
					...
					if(bnds!=null){
						...
						IntermediateVertexAssoc iv=(IntermediateVertexAssoc)parentCell;
						iv.setX(xx);
						iv.setY(yy);
						pos.setX1(xx);
						pos.setY1(yy);
