...
public class IntermediateVertexAssoc extends DefaultGraphCell implements MiddleVertex{
	...
	public IntermediateVertexAssoc(BiochamGraph graph,Object cell,double x, double y) {		
	...
	public IntermediateVertexAssoc(BiochamGraph graph) {
	...
	public IntermediateVertexAssoc(BiochamGraph graph,Object cell){
	...
	/*public IntermediateVertexAssoc(IntermediateVertex center,Object uo){
		userObject=uo;
		boolean set=false;
