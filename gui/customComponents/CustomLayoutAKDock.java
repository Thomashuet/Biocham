...
/**
 * Class thats creates a custom BorderLayout and applies it on the frames where toolbars are used (BiochamGraphEditorDesktop and BiochamMainFrame).
 * 
 * @author Dragana Jovanovska  
 */ 
public class CustomLayoutAKDock extends BorderLayout {
