...
public class CustomPopupCTL extends CustomPopupMenu{

	
	JPopupMenu menu;
	BiochamDynamicTree tree;
	ElementMenuBoolTemporal main;
	
	public CustomPopupCTL(BiochamDynamicTree tree){
		this.tree=tree;
	}
	
	
	public JPopupMenu getPopup(){		
		//menu=(tree.getCtlMenu().refreshedPopup(tree.currentModel));
		return menu;
	}
